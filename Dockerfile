...
# keyserver
ENV KEY_SERVER keyserver-02.2ndquadrant.com
...
RUN set -x \
    ...
    && export GNUPGHOME="$(mktemp -d)" \
    && gpg --keyserver $KEY_SERVER --recv-keys 595E85A6B1B4779EA4DAAEC70B588DFF0527A9B7 \
...
RUN set -x \
    ...
    && export GNUPGHOME="$(mktemp -d)" \
    && gpg --keyserver $KEY_SERVER --recv-keys D8749766A66DD714236A932C3B2D400CE5BBCA60 \
